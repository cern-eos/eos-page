...
func (s *Store) seedIfEmpty() error {
	...
	settings := map[string]string{
		...
		"community":          "http://eos-community.web.cern.ch/",
	...
	links := []Card{
		...
		{ID: "l-com", Kind: "link", Sort: 3, Visible: true, Title: "Community", Href: "http://eos-community.web.cern.ch/", Body: "Sites and operators"},
